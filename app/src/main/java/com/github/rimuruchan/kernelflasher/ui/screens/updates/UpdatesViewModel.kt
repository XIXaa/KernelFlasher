...
import com.github.rimuruchan.kernelflasher.common.types.room.AppDatabase
import com.github.rimuruchan.kernelflasher.common.types.room.updates.Update
import com.github.rimuruchan.kernelflasher.common.types.room.updates.UpdateSerializer
...
class UpdatesViewModel(
    ...
    private val db =
        Room.databaseBuilder(context, AppDatabase::class.java, "kernel-flasher").build()
    ...
    fun add(url: String, callback: (updateId: Int) -> Unit) {
        launch {
            ...
            client.newCall(request).execute().use { response ->
                ...
                val update: Update =
                    Json.decodeFromString(UpdateSerializer, response.body!!.string())
